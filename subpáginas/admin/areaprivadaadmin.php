        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="./areaprivadaadmin.php" id="areaPrivadaDropdown" role="button" data-bs-toggle="dropdown">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="dashboard-card text-center h-100">
                                    ...
                                    <a href="./paneldecontroladmin.php" class="btn btn-gold btn-sm">Panel de Control</a>
                                </div>
                            </div>
                        </div>
                    </div>
