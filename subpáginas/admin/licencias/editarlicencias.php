...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    editarlicencia($conn, $id_licencia);
}
?>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
                    <h1 class="form-title">Introduce el ID de la Licencia a Modificar</h1>
                    ...
                    <form method="POST" action="editarlicencias.php">
                        <div class="row justify-content-center">
                            <div class="col-md-6 text-center">
                                ...
                                <button type="submit" class="btn btn-gold mx-auto d-block">
                                    <i class="fas fa-plus-circle me-2"></i>EDITAR VIGENCIA DE LICENCIA
                                </button>
                            </div>
                        </div>
                    </form>
