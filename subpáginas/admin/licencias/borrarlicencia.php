...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    eliminarlicencia($conn, $id_licencia, $tipo_licencia);
}
?>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
                    <h1 class="form-title">Borrar Licencia</h1>
                    ...
                    <form method="POST" action="borrarlicencia.php">
                        <div class="row justify-content-center">
                            <div class="col-md-6 text-center">
                                <div class="mb-3">
                                    <label for="id_licencia" class="form-label">ID de la Licencia a Borrar</label>
                                ...
                                <button type="submit" class="btn btn-gold mx-auto d-block">
                                    <i class="fas fa-plus-circle me-2"></i>BORRAR LICENCIA
                                </button>
                            </div>
                        </div>
                    </form>
