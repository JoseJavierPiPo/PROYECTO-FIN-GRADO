...
<body>
    ...
    <div class="main-container">
        <br>
        <h1 class="form-title">BÚSQUEDA DE LICENCIA ASIGNADA A X SOCIOS</h1>
        
        <!-- Panel de búsqueda -->
        <div class="search-panel">
            <form action="filtrosociolicencias.php" method="POST">
                <div class="search-grid">
                    <!-- Campos principales -->
                    <div class="search-group">
                        <label for="nombre" class="form-label">Nombre Socio</label>
                        <input type="text" class="form-control" name="nombre" placeholder="Nombre Socio">
                    </div>
                    <div class="search-group">
                    ...
                    <div class="search-group">
                        ...
                        <input type="date" class="form-control" name="fecha_expedicion" placeholder="Fecha de Expedición">
                    </div>
                    <div class="search-group">
                        <label for="fecha_caducidad" class="form-label">Fecha de Caducidad</label>
                        <input type="date" class="form-control" name="fecha_caducidad" placeholder="Fecha de Caducidad">
                    </div>
                ...
                <div class="advanced-search" id="advancedSearch" style="display: none;">
                    ...
                    <div class="search-grid">
                        <div class="search-group">
                            <label for="numero_licencia" class="form-label">Numero de Licencia</label>
                            <input type="text" class="form-control" name="numero_licencia" maxlength="13">
                        </div>
                        <div class="search-group">
                        <label for="tipo_licencia" class="form-label">Tipo Licencia</label>
                            <select class="form-control" name="tipo_licencia">
                            <option value="" disabled selected>Selecciona un Tipo de Licencias</option>
                        ...
                        <div class="search-grid">
                        <div class="search-group">
                            <label for="numero_licencia_federativa" class="form-label">Numero de Licencia Federativa</label>
                            <input type="text" class="form-control" name="numero_licencia_federativa" maxlength="14">
                        </div>
                    </div>
                    <div class="search-group">
