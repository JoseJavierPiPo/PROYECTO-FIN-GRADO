        ...
        <section class="container my-5">
                <div class="row justify-content-center">
                        ...
                        <div class="dashboard-card text-center p-4">
                                <i class="fas fa-money-bill-wave icon-card mb-3 text-success"></i>
                                <h2 class="dashboard-title">Pago Realizado</h2>
                                <p class="mb-4">Tu pago se ha procesado correctamente. ¡Gracias por tu contribución a la Sociedad!</p>
