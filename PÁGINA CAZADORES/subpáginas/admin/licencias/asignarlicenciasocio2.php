...
<body>
    ...
    <div class="main-container">
        ...
        <div class="search-panel">
            <form action="asignarlicenciasocio2.php" method="POST">
                <div class="search-grid">
                    <!-- Campos principales -->
                    <div class="search-group">
                        <p>Selecciona el ID de licencia que quieras añadir al Socio introducido anteriormente</p>
                ...
                <button type="submit" class="btn-action"><i class="fas fa-search"></i> Asignar Licencia</button>
            </form>
        </div>
