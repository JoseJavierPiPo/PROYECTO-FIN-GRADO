...
<body>
        ...
        <div class="form-container">
            ...
            <?php if (isset($_SESSION['mensaje'])): ?>
                <div class="alert alert-<?php echo $_SESSION['tipo']; ?>" role="alert">
                    <i class='fas <?php echo $_SESSION['icono']; ?> me-2'></i><?php echo $_SESSION['mensaje']; ?>
                </div>
                <?php 
            ...
            <form action="../../../php/procesar_baja.php" method="POST">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="estado" placeholder="Selecciona un Estado" required>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Llamar a la función para modificar el estado del socio
        if(modificarestadosocio($conn, $dni, $nombre, $estado)) {
            $_SESSION['mensaje'] = 'Estado del socio modificado correctamente';
            $_SESSION['tipo_mensaje'] = 'success';
        } else {
            $_SESSION['mensaje'] = 'Error al modificar el estado del socio';
