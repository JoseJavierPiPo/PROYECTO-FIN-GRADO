...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    borrarmodalidad ($conn, $nombre, $id_modalidad);
}
?>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
                    ...
                    <form method="POST" action="borrarmodalidad.php">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="id_modalidad" class="form-label">ID_MODALIDAD</label>
                                    <input type="number" class="form-control" name="id_modalidad" requi>
                                </div>
                            </div>
                        </div>
                        
                        <button type="submit" class="btn btn-gold">
                            <i class="fas fa-plus-circle me-2"></i>BORRAR MODALIDAD
                        </button>
                    </form>
                </div>
            </div>
